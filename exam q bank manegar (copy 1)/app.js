...
const app = {
     ...
     */
    async init() {
        console.log('[App] Initializing v16.4.0 PRO...');
        this.initTheme();
        this.initLanguage();
        this.initDirection();
        this.initFontSize();
        ...
        document.getElementById('smartSearchBtn')?.addEventListener('click', () => {
            ...
            if (filterSearch) {
                if (window.innerWidth <= 768) {
                    ...
                    setTimeout(() => {
                        const drawerSearch = document.getElementById('filter-search-drawer'); // check if exists
    ...
    bridgeToExam(type = 'default') {
        ...
        ExportModule.bridgeToExam(
            ...
            (count) => UIComponents.showToast(`🚀 جاري نقل ${count} سؤال إلى محاكي الاختبار...`, 'success')
        );
    }
};
